...
public class GatewayConfig {
    ...
    private static final String DEFAULT_AUTH_SERVICE_URL = "http://heightful-backend-auth:8081";
    private static final String DEFAULT_IDENTITY_SERVICE_URL = "http://heightful-backend-identity:8082";
